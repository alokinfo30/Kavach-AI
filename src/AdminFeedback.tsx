...
import { Trash2, Download, MessageSquare, Loader2, ChevronLeft, ChevronRight, Search } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Review feedback collected across platform surfaces.</p>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        paginatedFeedback.map((item) => (
                            <tr key={item.id}>
                                ...
                                <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate">{item.message}</td>
