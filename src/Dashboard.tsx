...
export default function Dashboard() {
  ...
  const cards = [
    { name: 'Compliance Score', value: `${stats?.complianceScore ?? 0}%`, icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-50 dark:bg-green-950/30' },
    { name: 'Active Alerts', value: stats?.activeAlerts ?? 0, icon: AlertTriangle, color: 'text-amber-600', bg: 'bg-amber-50 dark:bg-amber-950/30', link: '/monitoring' },
    { name: 'Security Tests', value: stats?.securityTests ?? 0, icon: Shield, color: 'text-indigo-600', bg: 'bg-indigo-50 dark:bg-indigo-950/30', link: '/red-team' },
    { name: 'Models Monitored', value: stats?.modelsMonitored ?? 0, icon: Activity, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-950/30', link: '/monitoring' },
  ];
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((card) => (
          <div key={card.name} className="overflow-hidden rounded-lg bg-white dark:bg-gray-800 shadow transition-colors border border-gray-100 dark:border-gray-700">
            <div className="p-5">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        {/* Activity Chart */}
        <div className="rounded-lg bg-white dark:bg-gray-800 p-6 shadow lg:col-span-2 transition-colors border border-gray-100 dark:border-gray-700">
        ...
        <div className="rounded-lg bg-white dark:bg-gray-800 p-6 shadow transition-colors border border-gray-100 dark:border-gray-700">
      ...
      <div className="grid grid-cols-1 gap-8">
        {/* Recent Activity */}
        <div className="rounded-lg bg-white dark:bg-gray-800 shadow transition-colors border border-gray-100 dark:border-gray-700">
